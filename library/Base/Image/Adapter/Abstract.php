 ...
 * @subpackage  Adapter
 */
abstract class Base_Image_Adapter_Abstract
{
     ...
     * @return Base_Image_Adapter_Abstract
     */
    public function resizeIfBigger($maxWidth, $maxHeight, $minWidth = null, $minHeight = null)
    {
        $maxWidth = $maxWidth > $this->getSourceWidth() ? $this->getSourceWidth() : $maxWidth;
        $maxHeight = $maxHeight > $this->getSourceHeight() ? $this->getSourceWidth() : $maxHeight;
    ...
    public function resizeOutStrict($width, $height){
        $this->resizeInStrict($width, $height);
        return $this;
    }
    
    public function resizeInStrict($maxWidth, $maxHeight, $minWidth = null, $minHeight = null)
    {
        $this->_maxWidth = $maxWidth;
        $this->_maxHeight = $maxHeight;
        if(is_null($minWidth))
    ...
    protected function _generateThumbStrict()
    {
        $this->_initThumbStrict($this->_sourceWidth,
                          $this->_sourceHeight,
                          round($this->_maxWidth / $this->_maxHeight),
                          false,
                          $this->_maxWidth,
                          $this->_maxHeight,
                          $this->_minWidth,
                          $this->_minHeight);
//        die($this->_maxWidth.' '.$this->_maxHeight);
        $this->_newThumb($this->_maxWidth, $this->_maxHeight);
    ...
    protected function _initThumbStrict($sourceWidth, $sourceHeight, $scale, $inflate, $maxWidth,
        $maxHeight, $minWidth = null, $minHeight = null
    )
    {
            list($this->_thumbWidth, $this->_thumbHeight) = array($maxWidth,$maxHeight);//self::calculateSizeStrict($sourceWidth, $sourceHeight, $scale, $inflate, $maxWidth, $maxHeight, $minWidth = null, $minHeight = null);

        return $this;
    }
    
//    public static function calculateSizeStrict($sourceWidth, $sourceHeight, $scale, $inflate, $maxWidth,
//        $maxHeight, $minWidth = null, $minHeight = null)
//    {
//        return array($max, $thumbHeight);
//    }
//    
    /**
    ...
    protected function _generateThumb()
    {
        ...
        /* @todo copy not working correctly */
        if ( false && $this->_sourceWidth == $this->_maxWidth && $this->_sourceHeight == $this->_maxHeight) {
            $this->_thumb = $this->_source;
        } else {
            $this->_hasBeenModified = true;
            $this->_copyToThumb(
